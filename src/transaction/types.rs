...
//     [ML-DSA-87 sig (4627 B)] ‖ [P-521 sig (≤139 B)] ‖ [Ed448 sig (114 B)]
// - `pub_key` — the serialized composite public key (2782 bytes):
//     [ML-DSA-87 pk (2592 B)] ‖ [P-521 pk (133 B)] ‖ [Ed448 pk (57 B)]
...
pub struct BlackChainTxType {
    ...
    pub s: Option<U256>,
    /// Concatenated hybrid PQC signature: `[ML-DSA-87 ‖ P-521 ‖ Ed448]`.
    pub pqc_signature: Option<Bytes>,
    /// Serialized composite public key used by `recover_sender`:
    /// `[ML-DSA-87 pk ‖ P-521 pk ‖ Ed448 pk]` (2782 bytes total).
